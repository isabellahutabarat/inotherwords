...
const phrases = [
  ...
  { text: "ГЭЖ ТЭР САНАА ЗОВЖ АСУУВ", language: "MONGOLIAN" },
  { text: "DH'FHAIGHNICH I GU DRAGHAIL", language: "SCOTTISH GAELIC" },
  { text: "SI WELWEL LEH AYAY U WEYDIISAY", language: "SOMALI" },
  ...
  { text: "GOFYNNODD YN BRYDERUS", language: "WELSH" },
  { text: "DIA BERTANYA DENGAN CEMAS", language: "INDONESIAN" },
  { text: "ԱՆՀԱՆԳՍՏԱՑԱԾ ՀԱՐՑՐԵՑ ՆԱ", language: "ARMENIAN" },
  { text: "— деп уайымдап сұрады ол", language: "KAZAKH" },
  { text: "— ОБЕСПОКОЕННО СПРОСИЛ ОН", language: "RUSSIAN" },
  ...
  { text: "BWE YABUUZIZZA NGA MWERALIIKIRIVU", language: "GANDA" },
  { text: "VIŅŠ NORAIZĒJIES JAUTĀJA", language: "LATVIAN" },
  { text: "ಅವರು ಚಿಂತೆಯಿಂದ ಕೇಳಿದರು", language: "KANNADA" },
  { text: "ANAFUNSA MODANDAULA", language: "NYANJA" },
  { text: "YA TAMBAYA CIKIN TUHUMA", language: "HAUSA" },
  { text: "ШЕКОНЦА ХАЬТТИРА ЦО", language: "CHECHEN" },
  { text: "— ШУБХАКУНОН ПУРСИД У", language: "TAIJIK" },
  { text: "VROEG HIJ ACHTERDOCHTIG", language: "DUTCH" },
  { text: "KA UI IA TŪPATO", language: "MAORI" },
  { text: "AKU TERKEJUT DENGAN PERTANYAANKU", language: "INDONESIAN" },
  { text: "I WAS SURPRISED BY MY QUESTION", language: "NYANJA" },
